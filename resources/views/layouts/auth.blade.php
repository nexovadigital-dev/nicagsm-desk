...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/nexovadesklogo.svg') }}">
    <meta name="description" content="Panel de soporte y mensajería para NicaGSM. Accede para gestionar chats, tickets y configuración de tu chatbox.">
    <title>{{ $title ?? 'Acceder | NicaGSM ChatBox by Nexova Desk' }}</title>
...
<body>
    ...
    <div class="auth-left">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;text-align:center;padding-bottom:30px">
            <img src="{{ asset('images/nexovadesklogo.png') }}" alt="Nexova Desk"
                 style="width:155px;height:155px;border-radius:28px;object-fit:contain;margin-bottom:16px">
