...
<nav class="nav">
    ...
    <div class="nav-actions">
        @auth
            <a href="{{ auth()->user()?->is_super_admin ? '/superadmin' : '/admin' }}"
...
<div class="hero">
    <div>
        ...
        <div class="hero-actions">
            @auth
                <a href="{{ auth()->user()?->is_super_admin ? '/superadmin' : '/admin' }}" class="btn btn-lg btn-primary">
                    Ir a mi panel
                </a>
            @else
...
<section class="cta-section">
    @auth
        ...
        <a href="{{ auth()->user()?->is_super_admin ? '/superadmin' : '/admin' }}" class="btn btn-lg btn-primary" style="display:inline-flex;margin-inline:auto">
...
<footer class="footer">
    ...
    <div class="footer-links">
        @auth
            <a href="{{ auth()->user()?->is_super_admin ? '/superadmin' : '/admin' }}">Mi cuenta</a>
        @else
