...
<head>
    ...
    <title>500 — Error del servidor · Nexova Desk</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .code { font-size: clamp(80px, 18vw, 140px); font-weight: 800; line-height: 1; letter-spacing: -.05em; color: #f87171; }
        .title { font-size: clamp(20px, 4vw, 28px); font-weight: 700; margin: 12px 0 10px; }
        .desc { font-size: 15px; color: rgba(255,255,255,.45); text-align: center; max-width: 420px; line-height: 1.7; }
...
<body>
    ...
    <p class="desc">Algo salió mal en nuestro lado. Estamos trabajando para resolverlo. Intenta nuevamente en unos minutos.</p>
    <div class="actions">
        <a href="/" class="btn btn-primary">Ir al inicio</a>
        <a href="javascript:location.reload()" class="btn btn-ghost">Recargar página</a>
    </div>
