...
<div class="nx-kb-mgr">
    ...
    <div class="nx-kb-toolbar">
        ...
        {{-- Scrape sitio web --}}
        @if ($orgWebsite)
        <button wire:click="scrapeOrgWebsite"
                wire:confirm="¿Escanear {{ $orgWebsite }}?\n\nSe importarán hasta 20 páginas como artículos de conocimiento para este canal. Los artículos de scraping anteriores serán reemplazados."
                class="nx-kb-scrape-btn" wire:loading.attr="disabled" wire:target="scrapeOrgWebsite" {{ $isScraping ? 'disabled' : '' }}>
