...
.kb-item:hover { border-color: rgba(59,130,246,.3); }
...
.kb-form-input:focus, .kb-form-textarea:focus, .kb-form-select:focus { border-color: #3b82f6; }
...
.kb-toggle input:checked + .kb-slider { background: #3b82f6; }
