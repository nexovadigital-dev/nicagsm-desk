                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;gap:5px;flex-wrap:wrap">
                            ...
                            @if($org->partner_token)
                            <button x-data
                                    @click="navigator.clipboard.writeText('{{ $org->partner_token }}').then(()=>{ $dispatch('nexova-toast', {type:'success', message:'Token copiado'}) })"
                                    class="sa-btn" style="background:#f0f9ff;color:#0369a1;border:1px solid #bae6fd;font-family:ui-monospace,monospace;font-size:10px;letter-spacing:.03em"
                                    title="Copiar partner token">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="10" height="10" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                                {{ substr($org->partner_token, 0, 8) }}…
                            </button>
                            @endif
                            @else
