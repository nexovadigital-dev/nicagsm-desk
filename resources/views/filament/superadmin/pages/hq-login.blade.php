<div>
    ...
    @if($errors->has('data.email'))
        <div class="auth-error">{{ $errors->first('data.email') }}</div>
    @endif

    <div class="auth-field">
        <label class="auth-label">Email</label>
        <input type="email" wire:model.blur="data.email" class="auth-input"
    ...
    <div class="auth-field" style="margin-bottom:24px">
        ...
        <input type="password" wire:model.blur="data.password" class="auth-input"
