                ...
                {faqs.length > 0 && (
                    <div>
                        <p style={{ fontSize: 10, fontWeight: 700, color: '#9ca3af', textTransform: 'uppercase',
                            letterSpacing: '.06em', margin: '0 0 7px' }}>Preguntas frecuentes</p>
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            {faqs.map((faq, i) => (
                                <button key={i} onClick={() => onStartChat(faq.question)}
                                    style={{ background: 'none', border: 'none', borderBottom: `1px solid #f3f4f6`,
                                        padding: '9px 0', fontSize: 13, color: '#374151', cursor: 'pointer',
                                    ...
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                                        strokeLinecap="round" width="13" height="13" style={{ flexShrink: 0, opacity: .4 }}>
